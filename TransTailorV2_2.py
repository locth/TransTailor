...
def PlotLoss(train_loss, validate_loss):
...
if __name__ == "__main__":
    ...
    if os.path.isfile(CHECKPOINT_PATH):
        ...
        for epoch in range(TA_EPOCH):
            # Log losses during fine-tuning
            train_loss.append(pruner.Finetune(1, TA_LR, TA_MOMENTUM, epoch))
            validate_loss.append(CalculateAccuracy(pruner.model, validate_loader))
    ...
    # Plot Losses
    PlotLoss(train_loss, validate_loss)
